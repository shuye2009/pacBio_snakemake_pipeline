...
def get_all_outputs():
    ...
    outputs = [
        ...
        FUNC_BASE + "/dss_hyper_dmr_go_enrichment.tsv",
        FUNC_BASE + "/dss_hypo_dmr_go_enrichment.tsv",
        FUNC_BASE + "/dss_hyper_dmr_go_enrichment.png",
        FUNC_BASE + "/dss_hypo_dmr_go_enrichment.png",
        FUNC_BASE + "/dss_hyper_dmr_kegg_enrichment.tsv",
        FUNC_BASE + "/dss_hypo_dmr_kegg_enrichment.tsv",
        FUNC_BASE + "/dss_hyper_dmr_kegg_enrichment.png",
        FUNC_BASE + "/dss_hypo_dmr_kegg_enrichment.png",
        FUNC_BASE + "/dss_dmr_motif_enrichment.tsv",
        FUNC_BASE + "/dss_dmr_motif_enrichment.png",
        FUNC_BASE + "/dss_dmr_motif_enrichment.pdf",
        FUNC_BASE + "/dss_dmr_motif_enrichment.html",
